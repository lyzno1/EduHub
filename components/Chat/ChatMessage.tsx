...
export const ChatMessage: FC<Props> = memo(({ message, messageIndex, onEdit }) => {
  ...
  return (
    <div className={`py-3 ${isUser ? 'pl-16 pr-4' : 'pr-16 pl-4'}`}>
          ...
          {isUser ? (
            <div className="group">
              {isEditing ? (
                ...
                <div className="flex items-end gap-2">
                  ...
                  <div className="bg-gray-200 text-gray-800 px-4 py-2 rounded-2xl rounded-tr-none">
                    {message.content}
                  </div>
                </div>
              )}
            ...
            <div className="group">
              <div className="flex flex-col space-y-1">
                ...
                <div className="bg-gray-100 rounded-2xl rounded-tl-none px-4 py-3 dark:bg-gray-800">
